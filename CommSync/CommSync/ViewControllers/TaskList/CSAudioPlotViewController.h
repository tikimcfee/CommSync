...
@protocol CSAudioPlotActionDelegate <NSObject>
...
@property (assign, nonatomic) BOOL showShowSaveAndClose;
@property (weak, nonatomic) id <CSAudioPlotActionDelegate> saveDelegate;
