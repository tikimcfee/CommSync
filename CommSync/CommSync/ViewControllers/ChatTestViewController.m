...
//    [self.demoData.messages addObject:message];
    [_messageDataStore addObject:message];
...
{
    return [_messageDataStore objectAtIndex:indexPath.item];
}
...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForCellTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item % 3 == 0) {
        JSQMessage *message = [_messageDataStore objectAtIndex:indexPath.item];
...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForMessageBubbleTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item - 1 > 0) {
        JSQMessage *previousMessage = [_messageDataStore objectAtIndex:indexPath.item - 1];
...
{
    return [_messageDataStore count];
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JSQMessage *msg = [_messageDataStore objectAtIndex:indexPath.item];
                   ...
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForMessageBubbleTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     *  iOS7-style sender name labels
     */
    JSQMessage *currentMessage = [_messageDataStore objectAtIndex:indexPath.item];
